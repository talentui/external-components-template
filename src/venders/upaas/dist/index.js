...
exports.default = {
  ...
  propsCollections: _index4.default, //所有的属性组件
  pageTemplate: _index6.default //页面模版组件
}; /**在这里输出所有需要打包的组件**/
...
var _TemplateTwoColumn = __webpack_require__(10);

var _TemplateTwoColumn2 = _interopRequireDefault(_TemplateTwoColumn);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

exports.default = _TemplateTwoColumn2.default; /**
                                                * 在这个文件中输出页面模版组件
                                                * **/
...
var TemplateTwoColumn = function (_Component) {
    _inherits(TemplateTwoColumn, _Component);

    function TemplateTwoColumn() {
        _classCallCheck(this, TemplateTwoColumn);

        return _possibleConstructorReturn(this, (TemplateTwoColumn.__proto__ || Object.getPrototypeOf(TemplateTwoColumn)).apply(this, arguments));
    }

    _createClass(TemplateTwoColumn, [{
        key: 'render',
        value: function render() {
            var connectLayoutItem = this.props.connectLayoutItem;

            var el1 = connectLayoutItem('default1')(_react2.default.createElement('div', { className: 'pg-tmpl-default1' }));
            var el2 = connectLayoutItem('default2')(_react2.default.createElement('div', { className: 'pg-tmpl-default2' }));
            return _react2.default.createElement(
                'div',
                { className: 'pg-tmpl-defaul' },
                el1,
                el2
            );
        }
    ...
    return TemplateTwoColumn;
}(_react.Component);

exports.default = TemplateTwoColumn;
